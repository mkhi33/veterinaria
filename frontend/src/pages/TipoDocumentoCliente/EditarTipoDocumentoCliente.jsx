...
function EditarTipoDocumentoCliente({ open, handleClose, tipoDocumento, handleGuardarEdicion }) {
    ...
    const handleGuardar = () => {
        ...
        if (tipoDocumento) {
            if (validarInput(nuevoNombre)) {
                handleGuardarEdicion(tipoDocumento.tipoDocumentoID, { nombre: nuevoNombre });
            }
        }
    };
...
export default EditarTipoDocumentoCliente;
